...
function (_React$Component) {
      ...
      this.setState({
        ...
        if (_this2.state._page > _this2.state.totalPage) {
          ...
          Object(_utils_axios__WEBPACK_IMPORTED_MODULE_14__["default"])({
            url: _utils_api__WEBPACK_IMPORTED_MODULE_15__["api"].blog_list + "?page_size=10&page=".concat(_this2.state._page),
            type: 'get'
          }).then(function (res) {
  ...
  return Index;
}(react__WEBPACK_IMPORTED_MODULE_10___default.a.Component); // Index.getInitialProps = async function () {
...
//# sourceMappingURL=index.js.38032b9817567b9d8d9b.hot-update.js.map