      ...
      this.setState({
        ...
        if (_this2.state._page > _this2.state.totalPage) {
          ...
          Object(_utils_axios__WEBPACK_IMPORTED_MODULE_13__["default"])({
            url: _utils_api__WEBPACK_IMPORTED_MODULE_14__["api"].blog_list + "?page_size=10&page=".concat(_this2.state._page),
            type: 'get'
          }).then(function (res) {
...
//# sourceMappingURL=index.js.57f209136b7bd247deea.hot-update.js.map